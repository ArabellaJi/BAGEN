...
图都放在 [warehouse-5-test](${HOME}/BAGEN/figure/bagen/warehouse-5-test)。
...
- [warehouse_estimation_system.txt](${HOME}/BAGEN/scripts/evaluation-scripts/eval/prompts/warehouse_estimation_system.txt)
- [warehouse_estimation_user.txt](${HOME}/BAGEN/scripts/evaluation-scripts/eval/prompts/warehouse_estimation_user.txt)
...
- 文档汇总：[warehouse-summary.md](${HOME}/BAGEN/figure/bagen/warehouse-summary.md)
- 图和自动生成摘要：[warehouse-5-test](${HOME}/BAGEN/figure/bagen/warehouse-5-test)
- 自动作图脚本：[make_figures.py](${HOME}/BAGEN/figure/bagen/warehouse-5-test/make_figures.py)
- 自动摘要：[summary.md](${HOME}/BAGEN/figure/bagen/warehouse-5-test/summary.md)

...
OVERALL_ONLY_CONFIGS = [
    ...
    DatasetConfig(
        ...
        rollout_path=ROOT / "database/origin/swebench-origin-sera8b-128-main/results_128_v2_dialogues_incremental.json",
        estimation_path=ROOT / "database/estimation/swebench-origin-sera7b-128-main/swebench-token-estimation-main.json",
        progress_bins=10,
        reward_mode="stored",
    ),
]
